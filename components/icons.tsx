...
export const HistoryIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 2.221V5.25a.75.75 0 001.5 0V2.221" transform="rotate(-45 12 12)" />
    </svg>
);
...
export const DoubleCheckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="m8.5 8.75 6 6 9-13.5" />
    </svg>
);
...
export const ThumbsUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.97l-2.714 4.222a2 2 0 01-1.453 1.052H5a2 2 0 00-2 2v7a2 2 0 002 2h2.236a2 2 0 011.281.443l2.236 1.677A2 2 0 0014 21V10z" />
    </svg>
);

export const ThumbsDownIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.738 3h4.017c.163 0 .326.02.485.06L17 4m-7 10v5a2 2 0 002 2h.085a2 2 0 001.736-.97l2.714-4.222a2 2 0 011.453-1.052H19a2 2 0 002-2v-7a2 2 0 00-2-2h-2.236a2 2 0 01-1.281-.443l-2.236-1.677A2 2 0 0010 3v11z" />
    </svg>
);
...
export const SpinnerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.1266 6.87344L16.0659 7.93409" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.25 12L17.75 12" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.1266 17.1266L16.0659 16.0659" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19.25V17.75" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6.87344 17.1266L7.93409 16.0659" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.75 12L6.25 12" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6.87344 6.87344L7.93409 7.93409" />
    </svg>
);